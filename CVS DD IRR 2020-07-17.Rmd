...
# 1 - MA
```{r eval = TRUE, message = FALSE}
type1<- filter(data, data$ra_name.1 == "MA")
...
# 2 - EF
```{r eval = TRUE, message = FALSE}
type2<- filter(data, data$ra_name.1 == "EF")
...
# 3 - TL
```{r eval = TRUE, message = FALSE}
type3<- filter(data, data$ra_name.1 == "TL")
...
# 4 - CL
```{r eval = TRUE, message = FALSE}
type4<- filter(data, data$ra_name.1 == "CM")
...
# 5 - JW
```{r eval = TRUE, message = FALSE}
type5<- filter(data, data$ra_name.1 == "JW")
